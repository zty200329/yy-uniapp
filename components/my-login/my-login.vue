<template>
  <view class="my-container">
    ...
    <block v-else>
      ...
      <navigator url="../../pages/user_information/user_information" class="update-item">
        <button>修改信息</button>
      </navigator>
      <navigator url="../../pages/out_register/out_register" class="update-item">
        <button v-show="userInfo.role !== 0">出行确认</button>
      </navigator>
      <navigator url="../../pages/send_message/send_message" class="update-item">
        <button v-show="userInfo.role !== 0">订阅消息发送测试</button>
      </navigator>
...
import TuiButton from "../thorui/tui-button/tui-button";
