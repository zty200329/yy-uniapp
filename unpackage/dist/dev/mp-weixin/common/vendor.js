...
/***/ 12:
/*!*****************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/store/index.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 1. 导入 Vue 和 Vuex
...
var TOKEN_KEY = 'token';var _default =
{
  ...
  actions: {
    /**
              * 完成登录
              */
    loginAction: function loginAction(context, userProfile) {var _this = this;
      // 用户数据
      var rawData = JSON.parse(userProfile.rawData);
      var params = {
      ...
      return new Promise(function (resolve, reject) {
        (0, _user.login)(params).then(
        function (res) {
          var data = res;
          console.log(data);
          _this.commit('user/setToken', data.token);
          _this.commit('user/setNickName', data.nickName);
          _this.commit('user/setAvatar', data.avatarUrl);
          _this.commit('user/setUserInfo', data);
          resolve();
        }).catch(function (err) {
          reject();
        });
    ...
    /**
        * 进行登录判定
        */
    isLogin: function isLogin(context) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$uni$showModal, _yield$uni$showModal2, error, res, cancel, confirm;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!
                context.state.token) {_context.next = 2;break;}return _context.abrupt("return", true);case 2:_context.next = 4;return (

                  uni.showModal({
                    title: '登录之后才可以进行后续操作',
                    content: '立即跳转到登录页面？（登录后回自动返回当前页面哦~~~）' }));case 4:_yield$uni$showModal = _context.sent;_yield$uni$showModal2 = _slicedToArray(_yield$uni$showModal, 2);error = _yield$uni$showModal2[0];res = _yield$uni$showModal2[1];


                cancel =

                res.cancel, confirm = res.confirm;
                if (confirm) {
                  uni.navigateTo({
...
/***/ 18:
/*!**************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/api/user.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.login = login;exports.getUserInfo = getUserInfo;exports.updateUserInfo = updateUserInfo;var _request = _interopRequireDefault(__webpack_require__(/*! ../utils/request */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 42:
/*!*******************************************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/components/common/tui-utils/tui-utils.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var utils = {
  ...
  /**
      ...
      **/
  formatDate: function formatDate(formatStr, fdate) {var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var date = "";
    if (type === 3) {
      date = utils._formatTimeStr(fdate, formatStr);
    } else {
      date = utils._formatDate(formatStr, fdate, type);
    }
    return date;
  },
  _formatDate: function _formatDate(formatStr, fdate) {var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    if (!fdate) return;
  ...
  _formatTimeStr: function _formatTimeStr(timeStr, formatStr) {
    ...
    if (timeStr.length === 14) {
      ...
      var formatArr = [
      _toConsumableArray(timeArr).splice(0, 4).join(''),
      _toConsumableArray(timeArr).splice(4, 2).join(''),
      _toConsumableArray(timeArr).splice(6, 2).join(''),
      _toConsumableArray(timeArr).splice(8, 2).join(''),
      _toConsumableArray(timeArr).splice(10, 2).join(''),
      _toConsumableArray(timeArr).splice(12, 2).join('')];
  ...
  /**
      ...
      */
  debounce: function debounce(func) {var wait = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;var immediate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    var timer;
    return function () {
      var context = this,
      args = arguments;
  ...
  /**
      ...
      */
  throttle: function throttle(func) {var wait = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var previous = 0;
    var timeout;
    return function () {
      var context = this;
...

{
  ...
  throttle: utils.throttle };exports.default = _default;

/***/ }),

/***/ 49:
/*!**********************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/api/travel_query.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getCitys = getCitys;exports.travelQuery = travelQuery;var _request = _interopRequireDefault(__webpack_require__(/*! ../utils/request */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 5:
/*!*************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/pages.json ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 56:
/*!**********************************************************!*\
  !*** /Users/zty/Documents/uniapp/yy/api/travel_apply.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
